...
public class chatac implements ActionListener {
    JPanel p1;
    JTextField t1;
    JButton b1;
    static JPanel a1;
	...
	f1.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
       ...
       /*ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chata/icons/face.png"));
    ...
    public void actionPerformed(ActionEvent ae){  //adds messages sent by the client onto the jpanel. 
        ...
        try{
            ...
            vertical.add(right);
            vertical.add(Box.createVerticalStrut(15));  //to add gap between two sent messages.
            
            a1.add(vertical, BorderLayout.PAGE_START);  //to add message at the start(top right corner) of the frame.
            
            //a1.add(p2);
            dout.writeUTF(out); //to send the data to server(Chata).
            t1.setText("");
        }catch(Exception e){
    ...
    public static JPanel formatLabel(String out){
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");//to have time in the form of hours and minutes.
    ...
    public static void main(String[] args){
        new chatac().f1.setVisible(true);
        
        try{
            
            s = new Socket("127.0.0.1", 6001);  //localhost:127.0.0.1  6001 is port number
            din  = new DataInputStream(s.getInputStream());  //used to get data from the server.
	    ...
	    while(true){
                a1.setLayout(new BorderLayout());                       /*msginput = din.readUTF();  //utf
                                                                          ...
                                                                          JPanel left = new JPanel(new BorderLayout());
                                                                            ...
                                                                            vertical.add(left);
                                                                            f1.validate();*/
	        msginput = din.readUTF();    //readUTF learn
